          ...
          <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
            ...
            <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
              <div className="lg:w-1/2 px-6">
                ...
                <p className="mt-1">
                  Hub River Road 100ft Road Yousuf Goth St:25 Baldia Town
                  Karachi
                </p>
              </div>
              <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                ...
                <a className="text-blue-500 leading-relaxed cursor-pointer">
                  shehbazniazi1997@gmail.com
                </a>
                <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">
                  PHONE
                </h2>
                <p className="leading-relaxed">+92 3132865793</p>
              </div>
            </div>
          </div>
          <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
            ...
            <div className="relative mb-4">
              ...
              <input
                ...
                focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-base outline-none 
            ...
            <div className="relative mb-4">
              ...
              <textarea
                ...
                focus:ring-2 focus:ring-blue-200 h-32 text-base outline-none text-gray-700 py-1 px-3 
                resize-none leading-6 transition-colors duration-200 ease-in-out"
                defaultValue={""}
                required
              />
            </div>
            <button className="text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none 
            hover:bg-blue-600 rounded text-lg">
              Send message
            </button>
            </form>
          </div>
